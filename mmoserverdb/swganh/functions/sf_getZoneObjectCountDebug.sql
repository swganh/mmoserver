...
--
-- Definition of function `sf_getZoneObjectCountDebug`
--

DROP FUNCTION IF EXISTS `sf_getZoneObjectCountDebug`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER' */ $$
CREATE FUNCTION `sf_getZoneObjectCountDebug`(zoneId INT) RETURNS int(11) SQL SECURITY INVOKER
BEGIN
