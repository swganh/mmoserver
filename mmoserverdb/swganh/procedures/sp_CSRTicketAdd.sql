...
CREATE PROCEDURE `sp_CSRTicketAdd`(IN playerName TEXT, category INT, subCategory INT, ticketcomment TEXT, info TEXT, harrassing TEXT, lang CHAR(2), bugreport TINYINT(1)) SQL SECURITY INVOKER
BEGIN
