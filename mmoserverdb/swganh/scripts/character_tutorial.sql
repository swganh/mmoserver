...
DROP TABLE IF EXISTS `swganh`.`character_tutorial`;
CREATE TABLE  `swganh`.`character_tutorial` (
  `character_id` bigint(20) unsigned NOT NULL,
  `character_state` int(11) unsigned NOT NULL default '0',
...
--
-- Dumping data for table `swganh`.`character_tutorial`
--
