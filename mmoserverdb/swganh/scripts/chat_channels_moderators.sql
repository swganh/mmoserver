...
--
-- Definition of table `chat_channels_moderators`
--
...
--
-- Dumping data for table `chat_channels_moderators`
--

/*!40000 ALTER TABLE `chat_channels_moderators` DISABLE KEYS */;
/*!40000 ALTER TABLE `chat_channels_moderators` ENABLE KEYS */;
