...
--
-- Definition of table `container_item`
--
...
CREATE TABLE `container_item` (
  ...
  CONSTRAINT `container_item_ibfk_1` FOREIGN KEY (`container_id`) REFERENCES `containers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
