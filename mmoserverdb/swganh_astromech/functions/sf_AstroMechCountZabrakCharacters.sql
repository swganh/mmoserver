...
--
-- Definition of function `sf_AstroMechCountZabrakCharacters`
--

--
-- Administration Scripts
--
-- Select Count of Zabrak Characters
--

DELIMITER $$

DROP FUNCTION IF EXISTS `swganh_astromech`.`sf_AstroMechCountZabrakCharacters` $$
CREATE DEFINER=`root`@`localhost` FUNCTION `sf_AstroMechCountZabrakCharacters`() RETURNS int(5)
BEGIN
