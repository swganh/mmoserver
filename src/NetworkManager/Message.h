...
public:
    ...
    uint64                      getQueueTime(void)                {
        return mQueueTime;
    }
    bool                        getFastpath(void)                 {
        return mFastpath;
    }
    bool                        getPendingDelete(void)            {
    ...
    int8                        getInt8(void)                     {
        int8 value = *(int8*)&mData[mIndex];
        mIndex += sizeof(int8);
        return value;
    }
    uint8                       getUint8(void)                    {
        uint8 value = *(uint8*)&mData[mIndex];
        mIndex += sizeof(uint8);
        return value;
    }
    int16                       getInt16(void)                    {
        int16 value = *(int16*)&mData[mIndex];
        mIndex += sizeof(int16);
        return value;
    }
    uint16                      getUint16(void)                   {
        uint16 value = *(uint16*)&mData[mIndex];
        mIndex += sizeof(uint16);
        return value;
    }
    int32                       getInt32(void)                    {
        int32 value = *(int32*)&mData[mIndex];
        mIndex += sizeof(int32);
        return value;
    }
    uint32                      getUint32(void)                   {
        uint32 value = *(uint32*)&mData[mIndex];
        mIndex += sizeof(uint32);
        return value;
    }
    int64                       getInt64(void)                    {
        int64 value = *(int64*)&mData[mIndex];
        mIndex += sizeof(int64);
        return value;
    }
    uint64                      getUint64(void)                   {
        uint64 value = *(uint64*)&mData[mIndex];
        mIndex += sizeof(uint64);
        return value;
    }
    float                       getFloat(void)                    {
        float value = *(float*)&mData[mIndex];
        mIndex += sizeof(float);
        return value;
    }
    double                      getDouble(void)                   {
        double value = *(double*)&mData[mIndex];
