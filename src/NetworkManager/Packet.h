...
public:
  ...
  uint16                        getMaxPayload(void)                 { return mMaxPayLoad; }
  uint16                        getPacketType(void)                 { return *(uint16*)mData; }
  bool                          getIsCompressed(void)               { return mCompressed; }
  bool                          getIsEncrypted(void)                { return mEncrypted; }
  ...
  int16                         getInt16(void)                      { int16 value = *(int16*)&mData[mReadIndex]; mReadIndex += sizeof(int16); return value; }
  uint16                        getUint16(void)                     { uint16 value = *(uint16*)&mData[mReadIndex]; mReadIndex += sizeof(uint16); return value; }
  int32                         getInt32(void)                      { int32 value = *(int32*)&mData[mReadIndex]; mReadIndex += sizeof(int32); return value; }
  uint32                        getUint32(void)                     { uint32 value = *(uint32*)&mData[mReadIndex]; mReadIndex += sizeof(uint32); return value; }
  int64                         getInt64(void)                      { int64 value = *(int64*)&mData[mReadIndex]; mReadIndex += sizeof(int64); return value; }
  uint64                        getUint64(void)                     { uint64 value = *(uint64*)&mData[mReadIndex]; mReadIndex += sizeof(uint64); return value; }
  float                         getFloat(void)                      { float value = *(float*)&mData[mReadIndex]; mReadIndex += sizeof(float); return value; }
  double                        getDouble(void)                     { double value = *(double*)&mData[mReadIndex]; mReadIndex += sizeof(double); return value; }

  int8                          peekInt8(void)                      { int8 value = *(int8*)&mData[mReadIndex]; return value; }
  uint8                         peekUint8(void)                     { uint8 value = *(uint8*)&mData[mReadIndex]; return value; }
  int16                         peekInt16(void)                     { int16 value = *(int16*)&mData[mReadIndex]; return value; }
  uint16                        peekUint16(void)                    { uint16 value = *(uint16*)&mData[mReadIndex]; return value; }
  int32                         peekInt32(void)                     { int32 value = *(int32*)&mData[mReadIndex]; return value; }
  uint32                        peekUint32(void)                    { uint32 value = *(uint32*)&mData[mReadIndex]; return value; }
  int64                         peekInt64(void)                     { int64 value = *(int64*)&mData[mReadIndex]; return value; }
