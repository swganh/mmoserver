...
BuffManager::BuffManager(swganh::database::Database *database):mDatabase(database)
{
}
...
BuffManager* BuffManager::Init(swganh::database::Database *database)
{
    if(mInsFlag == false)
    {
...
void BuffManager::handleDatabaseJobComplete(void *ref, swganh::database::DatabaseResult *result)
{
    ...
    case BMQuery_Save_Async:
    {
        ...
        if(!playerObject->GetBuffAsyncCount())
        {
            ...
            mDatabase->executeSqlAsync(reinterpret_cast<swganh::database::DatabaseCallback*>(asyncContainer->callBack),asContainer,"UPDATE %s.characters SET parent_id=%"PRIu64",oX=%f,oY=%f,oZ=%f,oW=%f,x=%f,y=%f,z=%f,planet_id=%u,jedistate=%u WHERE id=%"PRIu64"",
...
void BuffManager::LoadBuffsFromResult(buffAsyncContainer* asyncContainer, swganh::database::DatabaseResult* result)
{
    swganh::database::DataBinding*	buffBinding = mDatabase->createDataBinding(9);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mBuffId),8,0);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mTargetId),8,1);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mInstigatorId),8,2);
    buffBinding->addField(swganh::database::DFT_uint32,offsetof(BuffDBItem,mMaxTicks),4,3);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mTickLength),8,4);
    buffBinding->addField(swganh::database::DFT_uint32,offsetof(BuffDBItem,mCurrentTick),4,5);
    buffBinding->addField(swganh::database::DFT_uint32,offsetof(BuffDBItem,mIconCRC),4,6);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mPausedGlobalTick),8,7);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffDBItem,mStartGlobalTick),8,8);
...
void BuffManager::LoadBuffAttributesFromResult(buffAsyncContainer* asyncContainer, swganh::database::DatabaseResult* result)
{

    swganh::database::DataBinding*	buffBinding = mDatabase->createDataBinding(4);
    buffBinding->addField(swganh::database::DFT_uint64,offsetof(BuffAttributeDBItem,mType),8,0);
    buffBinding->addField(swganh::database::DFT_int32,offsetof(BuffAttributeDBItem,mInitialValue),4,1);
    buffBinding->addField(swganh::database::DFT_int32,offsetof(BuffAttributeDBItem,mTickValue),4,2);
    buffBinding->addField(swganh::database::DFT_int32,offsetof(BuffAttributeDBItem,mFinalValue),4,3);
...
bool BuffManager::SaveBuffsAsync(WMAsyncContainer* asyncContainer,swganh::database::DatabaseCallback* callback, PlayerObject* playerObject, uint64 currenttime)
{
...
bool BuffManager::AddBuffToDB(WMAsyncContainer* asyncContainer,swganh::database::DatabaseCallback* callback, Buff* buff, uint64 currenttime)
{
