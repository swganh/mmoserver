...
void ContainerObjectFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
...
void ContainerObjectFactory::requestObject(ObjectFactoryCallback* ofCallback,uint64 id,uint16 subGroup,uint16 subType,DispatchClient* client)
{
    ...
    {
        // Just update the contents, if needed.
...
Container* ContainerObjectFactory::_createContainer(swganh::database::DatabaseResult* result)
{
...
void ContainerObjectFactory::_setupDatabindings()
{
    ...
    mContainerBinding->addField(swganh::database::DFT_uint64,offsetof(Container,mId),8,0);
    mContainerBinding->addField(swganh::database::DFT_uint64,offsetof(Container,mParentId),8,1);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mDirection.x),4,2);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mDirection.y),4,3);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mDirection.z),4,4);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mDirection.w),4,5);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mPosition.x),4,6);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mPosition.y),4,7);
    mContainerBinding->addField(swganh::database::DFT_float,offsetof(Container,mPosition.z),4,8);
    mContainerBinding->addField(swganh::database::DFT_uint32,offsetof(Container,mTanType),4,9);
    mContainerBinding->addField(swganh::database::DFT_bstring,offsetof(Container,mModel),256,10);
    mContainerBinding->addField(swganh::database::DFT_bstring,offsetof(Container,mName),64,11);
    mContainerBinding->addField(swganh::database::DFT_bstring,offsetof(Container,mNameFile),64,12);
    mContainerBinding->addField(swganh::database::DFT_bstring,offsetof(Container,mDetailFile),64,13);
}
...
void ContainerObjectFactory::handleObjectReady(Object* object,DispatchClient* client)
{
	...
	//hardcoded shit - get this in the db
