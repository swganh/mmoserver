...
ConversationManager::ConversationManager(swganh::database::Database* database) :
    mDatabase(database),
...
ConversationManager* ConversationManager::Init(swganh::database::Database* database)
{
    if(mInsFlag == false)
    {
...
void ConversationManager::handleDatabaseJobComplete(void* ref, swganh::database::DatabaseResult* result)
{
	//LOG(info) << "ConversationManager::handleDatabaseJobComplete";
    ...
    case ConvQuery_Conversations:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(Conversation,mId),4,0);
    ...
    case ConvQuery_Pages:
    {
        ...
        swganh::database::DataBinding*		pageBinding = mDatabase->createDataBinding(5);
        pageBinding->addField(swganh::database::DFT_uint32,offsetof(ConversationPage,mId),4,1);
        pageBinding->addField(swganh::database::DFT_bstring,offsetof(ConversationPage,mCustomText),512,2);
        pageBinding->addField(swganh::database::DFT_bstring,offsetof(ConversationPage,mStfFile),255,3);
        pageBinding->addField(swganh::database::DFT_bstring,offsetof(ConversationPage,mStfVariable),255,4);
        pageBinding->addField(swganh::database::DFT_uint32,offsetof(ConversationPage,mAnimation),4,6);

        swganh::database::DataBinding*	batchBinding = mDatabase->createDataBinding(1);
        batchBinding->addField(swganh::database::DFT_uint32,0,4,5);
    ...
    case ConvQuery_Page_OptionBatch:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(ConversationOption,mId),4,0);
        binding->addField(swganh::database::DFT_bstring,offsetof(ConversationOption,mCustomText),512,1);
        binding->addField(swganh::database::DFT_bstring,offsetof(ConversationOption,mStfFile),255,2);
        binding->addField(swganh::database::DFT_bstring,offsetof(ConversationOption,mStfVariable),255,3);
        binding->addField(swganh::database::DFT_uint32,offsetof(ConversationOption,mEvent),4,4);
        binding->addField(swganh::database::DFT_uint32,offsetof(ConversationOption,mPageLinkId),4,5);
	...
	//LOG(info) << "ConversationManager::handleDatabaseJobComplete end";
