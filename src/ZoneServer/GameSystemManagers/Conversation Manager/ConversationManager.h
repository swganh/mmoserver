...
class ConversationManager : public swganh::database::DatabaseCallback
{
public:

    static ConversationManager*		Init(swganh::database::Database* database);
...
private:
    ...
    ConversationManager(swganh::database::Database* database);
