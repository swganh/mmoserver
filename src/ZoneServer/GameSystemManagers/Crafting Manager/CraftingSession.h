...
class CraftingSession : public swganh::database::DatabaseCallback, public ObjectFactoryCallback
{
public:

    CraftingSession(Anh_Utils::Clock* clock,swganh::database::Database* database,PlayerObject* player,CraftingTool* tool,CraftingStation* station,uint32 expFlag);
    ~CraftingSession();
