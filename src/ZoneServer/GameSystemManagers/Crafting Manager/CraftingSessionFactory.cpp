...
CraftingSessionFactory*	CraftingSessionFactory::Init(swganh::database::Database* database)
{
    if(!mInsFlag)
    {
...
CraftingSessionFactory::CraftingSessionFactory(swganh::database::Database* database) :
    mDatabase(database),
