...
<<<<<<< HEAD:src/ZoneServer/GameSystemManagers/Crafting Manager/SchematicManager.cpp
...
>>>>>>> parent of 5bd772a... got rid of google log:src/ZoneServer/SchematicManager.cpp
...
SchematicManager::SchematicManager(swganh::database::Database* database)
...
SchematicManager* SchematicManager::Init(swganh::database::Database* database)
{
    if(mInsFlag == false)
    {
