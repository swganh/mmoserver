...
class SchematicManager : public swganh::database::DatabaseCallback
{
public:

    ~SchematicManager();
    static SchematicManager*	Init(swganh::database::Database* database);
...
private:
    ...
    SchematicManager(swganh::database::Database* database);
