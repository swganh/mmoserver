...
public:
    ...
    static GroupManager*	Init(swganh::database::Database* database,MessageDispatch* dispatch);

    GroupManager(swganh::database::Database* database,MessageDispatch* dispatch);
    ~GroupManager();
