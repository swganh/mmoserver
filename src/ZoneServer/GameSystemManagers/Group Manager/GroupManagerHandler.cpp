...
GroupManagerHandler::GroupManagerHandler(swganh::database::Database* database, MessageDispatch* dispatch)
{
    mDatabase = database;
...
GroupManagerHandler*	GroupManagerHandler::Init(swganh::database::Database* database, MessageDispatch* dispatch)
{
    if(!mInsFlag)
    {
