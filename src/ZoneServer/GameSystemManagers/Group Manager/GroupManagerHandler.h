...
class GroupManagerHandler : public swganh::database::DatabaseCallback
{
public:
    ...
    static GroupManagerHandler*	Init(swganh::database::Database* database,MessageDispatch* dispatch);

    GroupManagerHandler(swganh::database::Database* database,MessageDispatch* dispatch);
    ~GroupManagerHandler();
