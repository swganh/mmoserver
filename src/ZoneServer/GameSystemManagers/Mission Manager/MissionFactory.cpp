...
MissionFactory*	MissionFactory::Init(swganh::database::Database* database)
{
    if(!mInsFlag)
    {
...
//=============================================================================
//MissionFactory::MissionFactory(swganh::database::Database* database) : FactoryBase(database)
