...
MissionManager::MissionManager(swganh::database::Database* database, uint32 zone) :
    mDatabase(database)
{
...
MissionManager* MissionManager::Init(swganh::database::Database* database, uint32 zone)
{
    if(mInsFlag == false)
    {
...
void MissionManager::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
    ...
    case MissionQuery_Load_Names_File:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(Mission_Names,type),4,0);
        binding->addField(swganh::database::DFT_bstring,offsetof(Mission_Names,mission_name),64,1);
        binding->addField(swganh::database::DFT_bstring,offsetof(Mission_Names,name),64,2);
    ...
    case MissionQuery_Load_Names:
    {
        ...
        binding->addField(swganh::database::DFT_bstring,offsetof(Mission_Names,name),64,0);
    ...
    case MissionQuery_Load_Types:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(Mission_Types,id),4,0);
        binding->addField(swganh::database::DFT_bstring,offsetof(Mission_Types,stf),128,1);
        binding->addField(swganh::database::DFT_uint32,offsetof(Mission_Types,content),4,2);
        binding->addField(swganh::database::DFT_uint32,offsetof(Mission_Types,nameprovided),4,3);
    ...
    case MissionQuery_Load_Terminal_Type:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(Terminal_Mission_Link,id),4,0);
        binding->addField(swganh::database::DFT_uint64,offsetof(Terminal_Mission_Link,terminal),8,1);
        binding->addField(swganh::database::DFT_uint32,offsetof(Terminal_Mission_Link,mission_type),4,2);
        binding->addField(swganh::database::DFT_uint32,offsetof(Terminal_Mission_Link,content),4,3);
        binding->addField(swganh::database::DFT_uint32,offsetof(Terminal_Mission_Link,name),4,4);
        ...
        for(uint64 i = 0; i < count; i++)
        {
            ...
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"bounty")!= NULL)
            {
                terminalMissionLink->type = MissionTypeBounty;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"deliver")!= NULL)
            {
                terminalMissionLink->type = MissionTypeDeliver;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"dancer")!= NULL)
            {
                terminalMissionLink->type = MissionTypeDancer;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"escorttocreator")!= NULL)
            {
                terminalMissionLink->type = MissionTypeEscorttoCreator;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"escort")!= NULL)
            {
                terminalMissionLink->type = MissionTypeEscort;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"musician")!= NULL)
            {
                terminalMissionLink->type = MissionTypeMusician;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"hunting")!= NULL)
            {
                terminalMissionLink->type = MissionTypeHunting;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"recon")!= NULL)
            {
                terminalMissionLink->type = MissionTypeRecon;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"survey")!= NULL)
            {
            ...
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"medium")!= NULL)
            {
                terminalMissionLink->difficulty = MissionDifficulty_Medium;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"hard")!= NULL)
            {
            ...
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"neutral")!= NULL)
            {
                terminalMissionLink->faction = MissionFaction_Neutral;
            }
            else if(strstr(terminalMissionLink->missiontype->stf.getAnsi(),"imperial")!= NULL)
            {
...
void MissionManager::missionCompleteEntertainer(PlayerObject* player,Buff* timer)
{
    ...
    if(datapad->hasMission()) //player has a mission
    {
        ...
        {
            MissionObject* mission = dynamic_cast<MissionObject*>(*it);
            if(mission->getInProgress() == false) {
                ++it;
                continue;
            }
