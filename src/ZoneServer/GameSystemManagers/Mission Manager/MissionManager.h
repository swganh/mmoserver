...
class MissionManager : public swganh::database::DatabaseCallback
{
public:     // methods
    MissionManager(swganh::database::Database* database, uint32 zone);
    ~MissionManager();

    static MissionManager*  Init(swganh::database::Database* database, uint32 zone);
