...
//=============================================================================
    ...
    case NonPersistentNpcQuery_LairTemplate:
    {
        ...
        lairSpawnBinding->addField(swganh::database::DFT_uint64,offsetof(NpcLairEntityEx,mCreatureSpwanRegion),8,0);
        lairSpawnBinding->addField(swganh::database::DFT_uint64,offsetof(NpcLairEntityEx,mTemplateId),8,1);
        lairSpawnBinding->addField(swganh::database::DFT_uint32,offsetof(NpcLairEntityEx,mCreatureGroup),4,2);
        lairSpawnBinding->addField(swganh::database::DFT_uint32,offsetof(NpcLairEntityEx,mNumberOfLairs),4,3);
        lairSpawnBinding->addField(swganh::database::DFT_float,offsetof(NpcLairEntityEx,mSpawnPosX),4,4);
        lairSpawnBinding->addField(swganh::database::DFT_float,offsetof(NpcLairEntityEx,mSpawnPosZ),4,5);
        lairSpawnBinding->addField(swganh::database::DFT_float,offsetof(NpcLairEntityEx,mSpawnDirY),4,6);
        lairSpawnBinding->addField(swganh::database::DFT_float,offsetof(NpcLairEntityEx,mSpawnDirW),4,7);
        lairSpawnBinding->addField(swganh::database::DFT_uint32,offsetof(NpcLairEntityEx,mFamily),4,8);

        swganh::database::DataBinding* lairSpawnNpcBinding = mDatabase->createDataBinding(4);
        lairSpawnNpcBinding->addField(swganh::database::DFT_bstring,offsetof(NPCObject,mModel),255,9);
        lairSpawnNpcBinding->addField(swganh::database::DFT_bstring,offsetof(NPCObject,mSpecies),255,10);
        lairSpawnNpcBinding->addField(swganh::database::DFT_bstring,offsetof(NPCObject,mSpeciesGroup),255,11);
        lairSpawnNpcBinding->addField(swganh::database::DFT_bstring,offsetof(NPCObject,mFaction),32,12);
    ...
    case NonPersistentNpcQuery_LairCreatureTemplates:
    {
        ...
        swganh::database::DataBinding* creatureTemplateBinding = mDatabase->createDataBinding(1);
        creatureTemplateBinding->addField(swganh::database::DFT_uint64,0,8,0);
...
{
    LOG(error) << "whatever npc shit";
    // requestObject(ofCallback,id, 0);
}

//=============================================================================

NPCObject* NonPersistentNpcFactory::_createNonPersistentNpc(swganh::database::DatabaseResult* result, uint64 templateId, uint64 npcNewId, uint64 controllingObject)
{
    if (!result->getRowCount()) {
    	return nullptr;
    }
...
void NonPersistentNpcFactory::_setupDatabindings()
{
    ...
    mNonPersistentNpcBinding->addField(swganh::database::DFT_uint64,offsetof(NPCObject,mSpeciesId),8,0);
    mNonPersistentNpcBinding->addField(swganh::database::DFT_uint64,offsetof(NPCObject,mLootGroupId),8,1);
    ...
    mNonPersistentNpcBinding->addField(swganh::database::DFT_uint8,offsetof(NPCObject,mMoodId),1,9);
    mNonPersistentNpcBinding->addField(swganh::database::DFT_float,offsetof(NPCObject,mScale),4,10);

    mNpcIdentifierBinding = mDatabase->createDataBinding(1);
    mNpcIdentifierBinding->addField(swganh::database::DFT_uint32,offsetof(NpcIdentifier,mFamilyId),4,11);}
