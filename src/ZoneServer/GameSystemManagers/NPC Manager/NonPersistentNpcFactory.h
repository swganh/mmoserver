...
private:
    ...
    NPCObject*			_createNonPersistentNpc(swganh::database::DatabaseResult* result, uint64 templateId, uint64 npcNewId, uint64 controllingObject);
    NPCObject*			createNonPersistentNpc(swganh::database::DatabaseResult* result, uint64 templateId, uint64 npcNewId, uint32 familyId, uint64 controllingObject);

    static NonPersistentNpcFactory*	mSingleton;
    static bool						mInsFlag;

    swganh::database::DataBinding*					mNonPersistentNpcBinding;
