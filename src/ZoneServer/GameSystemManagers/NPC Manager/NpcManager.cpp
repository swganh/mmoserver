...
NpcManager::NpcManager(swganh::database::Database* database) :mDatabase(database)
{
    // _setupDatabindings();
    this->loadLairs();
}
...
void NpcManager::handleDatabaseJobComplete(void* ref, swganh::database::DatabaseResult* result)
{
    ...
    case NpcQuery_Lairs:
    {
        ...
        swganh::database::DataBinding* lairSpawnBinding = mDatabase->createDataBinding(3);
        lairSpawnBinding->addField(swganh::database::DFT_uint64,offsetof(NpcLairEntity,mLairsId),8,0);
        lairSpawnBinding->addField(swganh::database::DFT_uint64,offsetof(NpcLairEntity,mLairTemplateId),8,1);
        lairSpawnBinding->addField(swganh::database::DFT_uint32,offsetof(NpcLairEntity,mNumberOfLairs),4,2);
