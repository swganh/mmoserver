...
ResourceCollectionManager::ResourceCollectionManager(swganh::database::Database* database) :
    mDatabase(database),
...
ResourceCollectionManager* ResourceCollectionManager::Init(swganh::database::Database* database)
{
    if(mInsFlag == false)
    {
...
void ResourceCollectionManager::_setupDatabindings()
{
    ...
    mCommandCostBinding->addField(swganh::database::DFT_uint32,offsetof(ResourceCollectionCommand,mId),4,0);
    mCommandCostBinding->addField(swganh::database::DFT_bstring,offsetof(ResourceCollectionCommand,mCommandName),255,1);
    mCommandCostBinding->addField(swganh::database::DFT_int32,offsetof(ResourceCollectionCommand,mHealthCost),4,2);
    mCommandCostBinding->addField(swganh::database::DFT_int32,offsetof(ResourceCollectionCommand,mActionCost),4,3);
    mCommandCostBinding->addField(swganh::database::DFT_int32,offsetof(ResourceCollectionCommand,mMindCost),4,4);
    mCommandCostBinding->addField(swganh::database::DFT_int32,offsetof(ResourceCollectionCommand,mDamageModifier),4,5);
}
...
//======================================================================================================================
void ResourceCollectionManager::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
