...
//======================================================================================================================
class ResourceCollectionManager : public swganh::database::DatabaseCallback
{
public:

    ~ResourceCollectionManager();
    static ResourceCollectionManager*		Init(swganh::database::Database* database);
...
private:
    ...
    swganh::database::DataBinding*							mCommandCostBinding;
};
