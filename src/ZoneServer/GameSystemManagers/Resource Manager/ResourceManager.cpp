...
ResourceManager::ResourceManager(swganh::database::Database* database,uint32 zoneId, bool writeResourceMaps, std::string zoneName) :
    mDatabase(database),
    mZoneId(zoneId),
	mZoneName(zoneName),
...
ResourceManager* ResourceManager::Init(swganh::database::Database* database,uint32 zoneId, bool writeResourceMaps, std::string zoneName)
{
    if(mInsFlag == false)
    {
...
void ResourceManager::_setupDatabindings()
{
    ...
    mResourceTypebinding->addField(swganh::database::DFT_uint32,offsetof(ResourceType,mId),4,0);
    mResourceTypebinding->addField(swganh::database::DFT_uint16,offsetof(ResourceType,mCatId),2,1);
    ...
    mResourceCategorybinding->addField(swganh::database::DFT_uint32,offsetof(ResourceCategory,mId),4,0);
    mResourceCategorybinding->addField(swganh::database::DFT_bstring,offsetof(ResourceCategory,mName),255,1);
    mResourceCategorybinding->addField(swganh::database::DFT_bstring,offsetof(ResourceCategory,mDescriptor),255,2);
    mResourceCategorybinding->addField(swganh::database::DFT_uint32,offsetof(ResourceCategory,mParentId),4,3);

    mResourceBinding = mDatabase->createDataBinding(14);
    mResourceBinding->addField(swganh::database::DFT_uint64,offsetof(Resource,mId),8,0);
    mResourceBinding->addField(swganh::database::DFT_bstring,offsetof(Resource,mName),255,1);
    mResourceBinding->addField(swganh::database::DFT_uint32,offsetof(Resource,mTypeId),4,2);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_ER]),2,3);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_CR]),2,4);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_CD]),2,5);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_DR]),2,6);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_FL]),2,7);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_HR]),2,8);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_MA]),2,9);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_OQ]),2,10);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_SR]),2,11);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_UT]),2,12);
    mResourceBinding->addField(swganh::database::DFT_uint16,offsetof(Resource,mAttributes[ResAttr_PE]),2,13);

    mCurrentResourceBinding = mDatabase->createDataBinding(25);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint64,offsetof(CurrentResource,mId),8,0);
    mCurrentResourceBinding->addField(swganh::database::DFT_bstring,offsetof(CurrentResource,mName),255,1);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint32,offsetof(CurrentResource,mTypeId),4,2);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_ER]),2,3);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_CR]),2,4);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_CD]),2,5);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_DR]),2,6);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_FL]),2,7);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_HR]),2,8);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_MA]),2,9);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_OQ]),2,10);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_SR]),2,11);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_UT]),2,12);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint16,offsetof(CurrentResource,mAttributes[ResAttr_PE]),2,13);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapBoundsX1),8,14);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapBoundsX2),8,15);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapBoundsY1),8,16);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapBoundsY2),8,17);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint8,offsetof(CurrentResource,mNoiseMapOctaves),1,18);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapFrequency),8,19);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapPersistence),8,20);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapScale),8,21);
    mCurrentResourceBinding->addField(swganh::database::DFT_double,offsetof(CurrentResource,mNoiseMapBias),8,22);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint64,offsetof(CurrentResource,mUnitsTotal),8,23);
    mCurrentResourceBinding->addField(swganh::database::DFT_uint64,offsetof(CurrentResource,mUnitsLeft),8,24);
...
void ResourceManager::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
