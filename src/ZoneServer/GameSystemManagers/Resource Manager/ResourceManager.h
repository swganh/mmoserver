...
class ResourceManager : public swganh::database::DatabaseCallback
{
public:

    ~ResourceManager();
    static ResourceManager*		Init(swganh::database::Database* database,uint32 zoneId, bool writeResourceMaps, std::string zoneName);
...
private:
    ...
    ResourceManager(swganh::database::Database* database,uint32 zoneId, bool writeResourceMaps, std::string zoneName);
    ...
    swganh::database::DataBinding*				mResourceTypebinding;
    swganh::database::DataBinding*				mResourceCategorybinding;
    swganh::database::DataBinding*				mResourceBinding;
    swganh::database::DataBinding*				mCurrentResourceBinding;
};
