...
SkillManager::SkillManager(swganh::database::Database* database)
...
SkillManager* SkillManager::Init(swganh::database::Database* database)
{
    if(mInsFlag == false)
    {
...
void SkillManager::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
    ...
    case SMQuery_SkillMods:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(SMQueryContainer,mInt),4,0);
        binding->addField(swganh::database::DFT_string,offsetof(SMQueryContainer,mName),64,1);
    ...
    case SMQuery_XpTypes:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(SMQueryContainer,mInt),4,0);
        binding->addField(swganh::database::DFT_uint32,offsetof(SMQueryContainer,mInt2),4,1);
        binding->addField(swganh::database::DFT_string,offsetof(SMQueryContainer,mName),64,2);
        binding->addField(swganh::database::DFT_string,offsetof(SMQueryContainer,mName2),64,3);
    ...
    {
        Skill* skill;
        swganh::database::DataBinding* binding = mDatabase->createDataBinding(13);
        binding->addField(swganh::database::DFT_uint32,offsetof(Skill,mId),4,0);
        binding->addField(swganh::database::DFT_bstring,offsetof(Skill,mName),64,1);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mGodOnly),1,2);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mIsTitle),1,3);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mIsProfession),1,4);
        binding->addField(swganh::database::DFT_int32,offsetof(Skill,mMoneyRequired),4,5);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mSkillPointsRequired),1,6);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mXpType),1,7);
        binding->addField(swganh::database::DFT_int32,offsetof(Skill,mXpCost),4,8);
        binding->addField(swganh::database::DFT_int32,offsetof(Skill,mXpCap),4,9);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mJediStateRequired),1,10);
        binding->addField(swganh::database::DFT_uint8,offsetof(Skill,mIsSearchable),1,11);
        binding->addField(swganh::database::DFT_int32,offsetof(Skill,mBadgeId),4,12);
    ...
    case SMQuery_SkillSkillMods:
    {
        ...
        binding->addField(swganh::database::DFT_uint32,offsetof(SMQueryContainer,mInt),4,0);
        binding->addField(swganh::database::DFT_uint32,offsetof(SMQueryContainer,mInt2),4,1);
        binding->addField(swganh::database::DFT_int32,offsetof(SMQueryContainer,mInt3),4,2);
    ...
    case SMQuery_SkillDescriptions:
    {
        ...
        swganh::database::DataBinding* binding = mDatabase->createDataBinding(2);
        binding->addField(swganh::database::DFT_uint32,offsetof(SkillDescriptions,skillId),4,0);
        binding->addField(swganh::database::DFT_bstring,offsetof(SkillDescriptions,skillInfo),512,1);
