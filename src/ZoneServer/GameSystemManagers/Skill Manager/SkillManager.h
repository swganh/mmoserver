...
class SkillManager : public swganh::database::DatabaseCallback
{
public:

    ~SkillManager();
    static SkillManager*	Init(swganh::database::Database* database);
...
private:
    ...
    SkillManager(swganh::database::Database* database);
