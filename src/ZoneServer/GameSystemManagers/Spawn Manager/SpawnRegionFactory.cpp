...
SpawnRegionFactory::SpawnRegionFactory(swganh::database::Database* database) : FactoryBase(database) {}
...
void SpawnRegionFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result) {}
