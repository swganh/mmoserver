...
void BuildingFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
...
void BuildingFactory::_setupDatabindings()
{
    ...
    mBuildingBinding->addField(swganh::database::DFT_uint64,offsetof(BuildingObject,mId),8,0);
    mBuildingBinding->addField(swganh::database::DFT_float,offsetof(BuildingObject,mDirection.x),4,1);
    mBuildingBinding->addField(swganh::database::DFT_float,offsetof(BuildingObject,mDirection.y),4,2);
    mBuildingBinding->addField(swganh::database::DFT_float,offsetof(BuildingObject,mDirection.z),4,3);
    mBuildingBinding->addField(swganh::database::DFT_float,offsetof(BuildingObject,mDirection.w),4,4);
    ...
    mBuildingBinding->addField(swganh::database::DFT_bstring,offsetof(BuildingObject,mName),256,12);
    mBuildingBinding->addField(swganh::database::DFT_uint32,offsetof(BuildingObject,mBuildingFamily),4,13);

    mSpawnBinding = mDatabase->createDataBinding(9);
    mSpawnBinding->addField(swganh::database::DFT_uint64,offsetof(SpawnPoint,mCellId),8,0);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mDirection.x),4,1);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mDirection.y),4,2);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mDirection.z),4,3);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mDirection.w),4,4);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mPosition.x),4,5);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mPosition.y),4,6);
    mSpawnBinding->addField(swganh::database::DFT_float,offsetof(SpawnPoint,mPosition.z),4,7);
    mSpawnBinding->addField(swganh::database::DFT_bstring,offsetof(SpawnPoint,mName),256,8);
}
