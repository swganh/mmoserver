...
void HarvesterFactory::_createHarvester(swganh::database::DatabaseResult* result, HarvesterObject* harvester)
{
...
void HarvesterFactory::_setupDatabindings()
{
    ...
    mHarvesterBinding->addField(swganh::database::DFT_uint64,offsetof(HarvesterObject,mId),8,0);
    mHarvesterBinding->addField(swganh::database::DFT_uint64,offsetof(HarvesterObject,mOwner),8,1);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mDirection.x),4,2);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mDirection.y),4,3);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mDirection.z),4,4);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mDirection.w),4,5);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mPosition.x),4,6);
	...
	mHarvesterBinding->addField(swganh::database::DFT_stdu16string,offsetof(HarvesterObject,custom_name_),256,13);
    mHarvesterBinding->addField(swganh::database::DFT_uint8,offsetof(HarvesterObject,mLotsUsed),1,14);
    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,mResourceCategory),4,15);

    mHarvesterBinding->addField(swganh::database::DFT_uint64,offsetof(HarvesterObject,mCurrentResource),8,16);
    mHarvesterBinding->addField(swganh::database::DFT_uint8,offsetof(HarvesterObject,mActive),1,17);
    mHarvesterBinding->addField(swganh::database::DFT_float,offsetof(HarvesterObject,mCurrentExtractionRate),4,18);

    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,maint_cost_wk),4,19);
    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,mPowerUsed),4,20);
    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,mDamage),4,21);
    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,mMaxCondition),4,22);
    mHarvesterBinding->addField(swganh::database::DFT_uint32,offsetof(HarvesterObject,mRepairCost),4,23);
