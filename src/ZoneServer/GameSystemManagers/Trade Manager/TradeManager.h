...
class TradeManager : public swganh::database::DatabaseCallback
{
...
public:
    ...
    static TradeManager*	Init(swganh::database::Database* database,MessageDispatch* dispatch);
...
private:
    ...
    TradeManager(swganh::database::Database* database,MessageDispatch* dispatch);
