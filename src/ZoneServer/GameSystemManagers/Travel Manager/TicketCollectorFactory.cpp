...
void TicketCollectorFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
...
TicketCollector* TicketCollectorFactory::_createTicketCollector(swganh::database::DatabaseResult* result)
{
...
void TicketCollectorFactory::_setupDatabindings()
{
    ...
    mTicketCollectorBinding->addField(swganh::database::DFT_float,offsetof(TicketCollector,mDirection.w),4,6);
    mTicketCollectorBinding->addField(swganh::database::DFT_float,offsetof(TicketCollector,mPosition.x),4,7);
    mTicketCollectorBinding->addField(swganh::database::DFT_float,offsetof(TicketCollector,mPosition.y),4,8);
    mTicketCollectorBinding->addField(swganh::database::DFT_float,offsetof(TicketCollector,mPosition.z),4,9);
    mTicketCollectorBinding->addField(swganh::database::DFT_bstring,offsetof(TicketCollector,mName),64,11);
    mTicketCollectorBinding->addField(swganh::database::DFT_bstring,offsetof(TicketCollector,mNameFile),64,12);
    mTicketCollectorBinding->addField(swganh::database::DFT_bstring,offsetof(TicketCollector,mPortDescriptor),64,13);
}
