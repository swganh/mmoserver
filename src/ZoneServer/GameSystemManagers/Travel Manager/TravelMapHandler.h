...
class TravelMapHandler : public swganh::database::DatabaseCallback, public UICallback
{
public:
    ...
    static TravelMapHandler*	Init(swganh::database::Database* database,MessageDispatch* dispatch,uint32 zoneId);
...
private:
    ...
    TravelMapHandler(swganh::database::Database* database,MessageDispatch* dispatch,uint32 zoneId);
