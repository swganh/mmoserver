...
class TreasuryManager : public swganh::database::DatabaseCallback, UICallback
{
public:

    TreasuryManager(swganh::database::Database* database);
    ~TreasuryManager();

    static TreasuryManager*		    Init(swganh::database::Database* database);
