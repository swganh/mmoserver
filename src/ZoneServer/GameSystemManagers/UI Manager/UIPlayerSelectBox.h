...
public:
    ...
    UIPlayerSelectBox(UICallback* callback,uint32 id,const int8* eventStr,const int8* caption,const int8* prompt,const StringVector dataItems, PlayerList playerList, PlayerObject* playerObject,uint8 lbType)
