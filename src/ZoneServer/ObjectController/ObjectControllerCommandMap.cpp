...
ObjectControllerCommandMap::ObjectControllerCommandMap(swganh::database::Database* database) :
    mDatabase(database)
{
    // setup cpp hooks
    _registerCppHooks();
...
ObjectControllerCommandMap* ObjectControllerCommandMap::Init(swganh::database::Database* database)
{
    if(mInsFlag == false)
    {
...
void ObjectControllerCommandMap::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
    ObjectControllerCmdProperties* commandProperties;

    swganh::database::DataBinding* binding = mDatabase->createDataBinding(29);
    binding->addField(swganh::database::DFT_bstring,offsetof(ObjectControllerCmdProperties,mCommandStr),64,0);
    binding->addField(swganh::database::DFT_bstring,offsetof(ObjectControllerCmdProperties,mAbilityStr),64,1);
    binding->addField(swganh::database::DFT_uint64,offsetof(ObjectControllerCmdProperties,mStates),8,2);
    binding->addField(swganh::database::DFT_int32,offsetof(ObjectControllerCmdProperties,mHealthCost),4,3);
    binding->addField(swganh::database::DFT_int32,offsetof(ObjectControllerCmdProperties,mActionCost),4,4);
    binding->addField(swganh::database::DFT_int32,offsetof(ObjectControllerCmdProperties,mMindCost),4,5);
    binding->addField(swganh::database::DFT_uint32,offsetof(ObjectControllerCmdProperties,mAnimationCrc),4,6);
    binding->addField(swganh::database::DFT_uint8,offsetof(ObjectControllerCmdProperties,mAddToCombatQueue),1,7);
    binding->addField(swganh::database::DFT_uint64,offsetof(ObjectControllerCmdProperties,mDefaultTime),8,8);
    binding->addField(swganh::database::DFT_bstring,offsetof(ObjectControllerCmdProperties,mScriptHook),32,9);
    binding->addField(swganh::database::DFT_uint32,offsetof(ObjectControllerCmdProperties,mRequiredWeaponGroup),4,10);
    binding->addField(swganh::database::DFT_bstring,offsetof(ObjectControllerCmdProperties,mCbtSpam),32,11);
    ...
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mKnockdownChance),4,19);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mDizzyChance),4,20);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mBlindChance),4,21);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mStunChance),4,22);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mIntimidateChance),4,23);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mPostureDownChance),4,24);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mExtendedRange),4,25);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mDamageMultiplier),4,26);
    binding->addField(swganh::database::DFT_float,offsetof(ObjectControllerCmdProperties,mDelayMultiplier),4,27);
    binding->addField(swganh::database::DFT_uint64,offsetof(ObjectControllerCmdProperties,mLocomotionMask),8,28);
...
void ObjectControllerCommandMap::_registerCppHooks()
{
	...
	mCommandMap.insert(std::make_pair(opOCAdminTeleportTo, std::bind(&ObjectController::_handleAdminTeleportTo, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)));
	mCommandMap.insert(std::make_pair(opOCAdminTeleportTarget, std::bind(&ObjectController::_handleAdminTeleportTarget, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)));
	mCommandMap.insert(std::make_pair(opOCAdminSetName, std::bind(&ObjectController::_handleAdminSetName, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)));
