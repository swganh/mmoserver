...
class ObjectControllerCommandMap : public swganh::database::DatabaseCallback
{
public:
    ...
    static ObjectControllerCommandMap*	Init(swganh::database::Database* database);
...
private:
    ...
    ObjectControllerCommandMap(swganh::database::Database* database);
