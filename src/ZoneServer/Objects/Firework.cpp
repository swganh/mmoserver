...
#include "Firework.h"
#include "ZoneServer/GameSystemManagers/FireworkEvent.h"
...
void FireworkShow::handleUIEvent(uint32 action,int32 element,std::u16string inputStr,UIWindow* window)
{
}
