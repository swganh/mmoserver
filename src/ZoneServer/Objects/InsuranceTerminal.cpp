                    ...
                    while (it != mSortedInsuranceList.end())
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                gWorldManager->getKernel()->GetDatabase()->executeSqlAsync(NULL,NULL,"UPDATE %s.item_attributes SET value=1 WHERE item_id=%"PRIu64" AND attribute_id=%u",gWorldManager->getKernel()->GetDatabase()->galaxy(),tangibleObject->getId(), 1270);
