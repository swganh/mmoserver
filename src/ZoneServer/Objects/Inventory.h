...
public:
	...
	*/
	...
	/*	@brief checks whether we have space for amount items
	*	/param amount amount we need in the inventory
	*	/param player	the player we send our error msg to in case of failure
	*/
