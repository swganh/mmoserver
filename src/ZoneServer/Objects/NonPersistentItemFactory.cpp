...
void NonPersistentItemFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
...
Item* NonPersistentItemFactory::_createItem(swganh::database::DatabaseResult* result, uint64 newId)
{
...
void NonPersistentItemFactory::_setupDatabindings()
{
    ...
    mItemIdentifierBinding->addField(swganh::database::DFT_uint32,offsetof(ItemIdentifier,mFamilyId),4,0);
    mItemIdentifierBinding->addField(swganh::database::DFT_uint32,offsetof(ItemIdentifier,mTypeId),4,1);
