...
void VehicleControllerFactory::handleDatabaseJobComplete(void* ref,swganh::database::DatabaseResult* result)
{
...
VehicleController* VehicleControllerFactory::_createVehicle(swganh::database::DatabaseResult* result)
{
...
void VehicleControllerFactory::_setupDatabindings()
{
    ...
    mVehicleCreo_Binding->addField(swganh::database::DFT_uint32,offsetof(VehicleController,type_id_),4,0);
    mVehicleCreo_Binding->addField(swganh::database::DFT_uint64,offsetof(VehicleController,mParentId),8,1);
    mVehicleCreo_Binding->addField(swganh::database::DFT_uint32,offsetof(VehicleController,hit_point_loss_),4,2);
    mVehicleCreo_Binding->addField(swganh::database::DFT_uint32,offsetof(VehicleController,incline_acceleration_),4,3);
    mVehicleCreo_Binding->addField(swganh::database::DFT_uint32,offsetof(VehicleController,flat_acceleration_),4,4);
