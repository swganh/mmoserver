...
private:
    ...
    VehicleController*			_createVehicle(swganh::database::DatabaseResult* result);

    static VehicleControllerFactory*	mSingleton;
    static bool					mInsFlag;

    swganh::database::DataBinding*				mVehicleItno_Binding;
    swganh::database::DataBinding*				mVehicleCreo_Binding;
